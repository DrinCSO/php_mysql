<?php
    ...
    $selecetUsers = $conn->prepare($sql);
    $selectUsers->excecute();
...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-black -bg-light -sidebar collapse">
          ...
          <li class="nav-item">
            <a class="nav-link" href="bookings.php">
              ...
              Bookings
                 ...
                 <?php   }else{?>
                        <li class="nav-item">
                            <a href="home.php" clas="nac-link">Home</a>
                        </li>
                        <li class="nav-item">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <?php if($_SESSION['isdmin'] == 'true'){?>
                <h2>Users </h2>
                <div class="table-responsive">
                    <table class="table table_stripped table-sm">
                        <thead>
                            <tr>
                                <th scope="col">ID</th>
